...
kernel.elf: kernel/kernel.c kernel/virtio.c kernel/fat16.c kernel/kernel.ld shell.bin.o common_types.h
	$(CC) $(CFLAGS) -Wl,-Tkernel/kernel.ld -Wl,-Map=kernel.map -o $@ \
		kernel/kernel.c kernel/virtio.c kernel/fat16.c shell.bin.o
